...
RegisterNetEvent('fishing:server:SellillegalFish', function(args)
	...
	if args == 1 then 
		...
		if dolphin ~= nil then
			...
			TriggerClientEvent("ez-fishing:client:SellillegalFish", source)
		else
...
RegisterNetEvent('fishing:server:SellLegalFish', function(args) 
	...
	if args == 1 then 
		...
		if mackerel ~= nil then
			...
			TriggerClientEvent("ez-fishing:client:SellLegalFish", source)
		else
...
RegisterNetEvent('fishing:server:BuyFishingGear', function(args)
	...
	if args == 1 then 
		if bankBalance >= Config.fishingBaitPrice then
			...
			TriggerClientEvent("ez-fishing:client:buyFishingGear", source)
		else

...
RequestIpl("tunergarage_milo_")
    ...
    DisableInteriorProp(interiorID, "entity_set_bombs") 
    ...
    DisableInteriorProp(interiorID, "entity_set_car_lift_default") 
    ...
    EnableInteriorProp(interiorID, "entity_set_style_7") 

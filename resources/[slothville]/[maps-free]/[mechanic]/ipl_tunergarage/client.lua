...
RequestIpl("tunergarage_milo_")
    ...
    DisableInteriorProp(interiorID, "entity_set_bedroom") 
    EnableInteriorProp(interiorID, "entity_set_bedroom_empty") 
    EnableInteriorProp(interiorID, "entity_set_bombs") 
    EnableInteriorProp(interiorID, "entity_set_box_clutter") 
    ...
    DisableInteriorProp(interiorID, "entity_set_car_lift_purchase") 
    ...
    DisableInteriorProp(interiorID, "entity_set_style_6") 
    DisableInteriorProp(interiorID, "entity_set_style_7") 
    DisableInteriorProp(interiorID, "entity_set_style_8") 
    EnableInteriorProp(interiorID, "entity_set_style_9") 
    --
    EnableInteriorProp(interiorID, "entity_set_table") 

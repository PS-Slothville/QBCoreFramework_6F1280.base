...
Config.RentalBoat = "smallboat"                                    -- Fishing boat of Choice
...
Config.TestFish = false											-- Test Fish with commands /startfish or /spawnfish                          	-- Must choose one of the avalible skillbars ["reload-skillbar","np-skillbar","qb-skillbar"]

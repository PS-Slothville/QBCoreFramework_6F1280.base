...
Config.Shops = {
    ...
    bennys = { -- Default Bennys Location
        ...
        shop = vector3(-242.9118, -1326.3867, 31.0361),
        duty = vector3(-216.1153, -1339.2041, 31.6274),
        stash = vector3(-242.9118, -1324.6935, 31.0324),
        paint = vector3(-233.4013, -1338.7993, 30.9514),
        vehicles = {

...
RegisterNetEvent("ps-dispatch:client:officerdown", OfficerDown)
...
RegisterNetEvent("ps-dispatch:client:officerbackup", OfficerBackup)
...
RegisterNetEvent("ps-dispatch:client:officerdistress", OfficerInDistress)

...
Config.items = {
    {item = "encryptedtablet", label = "Encrypted Tablet", minStock = 2, maxStock = 5, price = 5000, image = "tablet.png"},
    {item = "racing_gps", label = "Racing Tablet", minStock = 20, maxStock = 20, price = 2000, image = "racing_gps.png"},
    {item = "nitrous", label = "Nitrous", minStock = 5, maxStock = 5, price = 1500, image = "nitrous.png"},
    {item = "weapon_heavypistol", label = "Heavy Pistol", minStock = 3, maxStock = 5, price = 7500, image = "weapon_heavypistol.png"},
    {item = "heavyarmor", label = "Heavy Armor", minStock = 15, maxStock = 20, price = 500, image = "armor.png"},
